 ...
 *  A. This works fine
 *  ------------------
struct normal_store  { static constexpr std::true_type tid() {return std::true_type{};} };
struct reverse_store { static constexpr std::false_type tid() {return std::false_type{};} };
