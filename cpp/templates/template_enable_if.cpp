...
template <class T, typename = std::enable_if_t<T::usable>> class d {
private:
  T m;
...
public:
  ...
  template <class S, typename = std::enable_if_t<T::usable>,
            typename = std::enable_if_t<
                std::is_same<T, decltype(static_cast<T>(S{}))>::value, bool>>
  d(S s) : m{} {};
};
